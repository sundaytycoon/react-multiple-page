...
var MultiplePageView = function (_Component) {
  ...
  function MultiplePageView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MultiplePageView.__proto__ || Object.getPrototypeOf(MultiplePageView)).call.apply(_ref, [this].concat(args))), _this), _this.state = { when: _this.props.when, message: _this.props.message }, _this.nextPage = function () {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        pages.map(function (PageComponent, index) {
          ...
          return index === location.state.page;
        }),
