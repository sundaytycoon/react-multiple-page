      ...
      <div className="page">
        <div className="form-control">
          ...
          <label htmlFor={nickname}>
            <input type="text" value={inputs.nickname.value} id={nickname} name={nickname} onChange={(e) => { handleChange('nickname', e.target.value) }}/>
        ...
        <div className="form-control">
          ...
          <label htmlFor={phone}>
            <input type="tel" value={inputs.phone.value} id={phone} name={phone} onChange={(e) => { handleChange('phone', e.target.value) }}/>
